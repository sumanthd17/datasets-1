...
The below description is adapted from the OGB paper:
...
## Prediction
The task is to predict 128 different biological activity targets.
...
class OgbgMolpcba(tfds.core.GeneratorBasedBuilder):
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    print(type(path), type(data_path))
    all_data, split_indices = self._read_extracted_data(data_path, split_path)
